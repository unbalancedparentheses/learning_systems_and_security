...
- [Nand2Tetris: Build a Modern Computer from First Principles](https://www.nand2tetris.org/)
- [x86 bare metal examples](https://github.com/cirosantilli/x86-bare-metal-examples)
- [SkullSecurity Assembly Wiki](https://wiki.skullsecurity.org/Assembly)
- [RPISEC MBE: Modern Binary Exploitation](https://github.com/RPISEC/MBE)
- [OpenSecurityTraining: The Life of Binaries](http://opensecuritytraining.info/LifeOfBinaries.html)
- [OpenSecurityTraining: Introductory Intel x86](http://opensecuritytraining.info/IntroX86.html)
...
- [Insecure Programming](https://github.com/gerasdf/InsecureProgramming)
...
- [Readings in Database Systems - Peter Bailis, Joseph M. Hellerstein, Michael Stonebraker](http://www.redbook.io/all-chapters.html)
...
- [A Note on Distributed Computing - Jim Waldo et al.](https://scholar.harvard.edu/files/waldo/files/waldo-94.pdf)
...
- [CS143 Compilers - Stanford](https://web.stanford.edu/class/archive/cs/cs143/cs143.1128/)
- [Tiger: Toy compiler implementation in OCaml](https://github.com/thizanne/tiger)
- [Types and Programming Languages - Benjamin C. Pierce](https://www.cis.upenn.edu/~bcpierce/tapl/)
- [lambda_calculus: Untyped lambda calculus in Rust](https://github.com/ljedrz/lambda_calculus)
...
- [coollang-2020-fs: Compiler for a small Scala subset in F#](https://mykolav.github.io/coollang-2020-fs/)
- [Toy Compiler Using Ocamllex, Menhir, and LLVM - Daniel Volya](https://volya.xyz/blog/toy-compiler/)
- [OCaml Programming: Type Checking chapter - Cornell CS 3110](https://cs3110.github.io/textbook/chapters/interp/typecheck.html)
...
- [The Programming Languages Zoo - Andrej Bauer](https://plzoo.andrej.com)
...
- [Elliptic curves in simple Weierstrass form - Trustica](https://www.youtube.com/playlist?list=PLN9KZDpNfsHMd7d7PX87JGesGY_Qzyb3V)
- [18.783 Elliptic Curves - MIT](https://math.mit.edu/classes/18.783/2022/lectures.html)
